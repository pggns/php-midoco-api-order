...
/**
 * This class stands for GetOrderICalContentRequest StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetOrderICalContentRequest extends AbstractStructBase
{
    /**
     * The icalId
     * @var int|null
    ...
    /**
     * Constructor method for GetOrderICalContentRequest
     * @uses GetOrderICalContentRequest::setIcalId()
     * @uses GetOrderICalContentRequest::setOrderId()
     * @uses GetOrderICalContentRequest::setUnitName()
     * @param int $icalId
     * @param int $orderId
     ...
     * Set icalId value
     * @param int $icalId
     * @return \Pggns\MidocoApi\Order\StructType\GetOrderICalContentRequest
     */

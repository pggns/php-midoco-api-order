...
/**
 * This class stands for ExportChangedOrdersLogResultDTO StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ExportChangedOrdersLogResultDTO extends AbstractStructBase
{
    /**
     * The changeId
     * @var int|null
    ...
    /**
     * Constructor method for ExportChangedOrdersLogResultDTO
     * @uses ExportChangedOrdersLogResultDTO::setChangeId()
     * @uses ExportChangedOrdersLogResultDTO::setFirstRequestTime()
     * @uses ExportChangedOrdersLogResultDTO::setIsExported()
     * @uses ExportChangedOrdersLogResultDTO::setIsIgnored()
     * @uses ExportChangedOrdersLogResultDTO::setLastRequestTime()
     * @uses ExportChangedOrdersLogResultDTO::setRequestTime()
     * @uses ExportChangedOrdersLogResultDTO::setResponseCode()
     * @uses ExportChangedOrdersLogResultDTO::setSystemName()
     * @uses ExportChangedOrdersLogResultDTO::setTryCount()
     * @param int $changeId
     ...
     * Set changeId value
     * @param int $changeId
     * @return \Pggns\MidocoApi\Order\StructType\ExportChangedOrdersLogResultDTO
     */

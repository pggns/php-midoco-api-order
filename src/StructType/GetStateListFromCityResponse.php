...
class GetStateListFromCityResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCityForArrayConstraintFromSetMidocoCity(?array $values = []): string
    {
        ...
        foreach ($values as $getStateListFromCityResponseMidocoCityItem) {
            ...
            if (!$getStateListFromCityResponseMidocoCityItem instanceof \Pggns\MidocoApi\Order\StructType\CityDTO) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\CityDTO[] $midocoCity
     * @return \Pggns\MidocoApi\Order\StructType\GetStateListFromCityResponse
     */

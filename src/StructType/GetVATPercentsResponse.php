...
class GetVATPercentsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoVatDefinitionForArrayConstraintFromSetMidocoVatDefinition(?array $values = []): string
    {
        ...
        foreach ($values as $getVATPercentsResponseMidocoVatDefinitionItem) {
            ...
            if (!$getVATPercentsResponseMidocoVatDefinitionItem instanceof \Pggns\MidocoApi\Order\StructType\MidocoVatDefinition) {
     ...
     * @param \Pggns\MidocoApi\Order\StructType\MidocoVatDefinition[] $midocoVatDefinition
     * @return \Pggns\MidocoApi\Order\StructType\GetVATPercentsResponse
     */
